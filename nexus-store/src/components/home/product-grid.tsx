...
const MOCK_PRODUCTS: Product[] = [
  { id: "1", name: "Lumina Earbuds", category: "Audio", price: 199, image: "/product_bag.png" },
  { id: "2", name: "Aero Smartwatch", category: "Wearables", price: 299, image: "/product_watch.png" },
  { id: "3", name: "Nebula Perfume", category: "Fragrance", price: 149, image: "/product_perfume.png" },
  { id: "4", name: "Eclipse Shades", category: "Accessories", price: 189, image: "/product_sunglasses.png" },
];
    ...
    <section className="py-24 px-6 container mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-end mb-12">
        ...
        <div className="flex gap-4 mt-6 md:mt-0">
          <button className="px-6 py-2 rounded-full border border-border text-sm font-medium hover:bg-secondary transition-colors">All</button>
          <button className="px-6 py-2 rounded-full border border-border text-sm font-medium hover:bg-secondary transition-colors">Tech</button>
          <button className="px-6 py-2 rounded-full border border-border text-sm font-medium hover:bg-secondary transition-colors">Fashion</button>
        </div>
      </div>
